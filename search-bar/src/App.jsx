...
class App extends Component {
	...
	handleClick(i) {
		...
		newState.products[3].children.map((e) => {
			newState.products[e - 1].visible = !newState.products[e - 1].visible;
    });
    
    
    this.setState({ newState });*/

		const carArray = [ { id: '1', name: 'test', isInStock: false, visible: true, children: [ 2, 3 ] } ];
		this.setState({
			products: [ ...this.state.products, ...carArray ]
		});
	}
	...
	render() {
		return (
			<div className="App">
				...
				<input type="button" value="click" onClick={() => this.handleClick(4)} />
